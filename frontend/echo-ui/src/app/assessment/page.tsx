  ...
  return (
    <AppLayout>
      ...
      >
        ...
        <motion.div variants={itemVariants} className="rounded-2xl glass-panel p-8 border border-border grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          <div className="md:col-span-8 space-y-3">
            ...
            <div className="flex items-center gap-3 pt-2">
              <Link href="/reasoning">
                <Button variant="champagne" size="sm" className="gap-2 font-bold shadow-lg shadow-sm">
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <Card champagneBorder className="md:col-span-6 p-6 space-y-6">
            <CardHeader className="p-0">
              <CardTitle className="text-base font-bold text-white flex items-center gap-2">
                <Sliders className="w-5 h-5 text-foreground" /> Interactive Readiness Simulator
              </CardTitle>
            ...
            <form onSubmit={handleRecalculate} className="space-y-5">
              <div className="space-y-2">
                <div className="flex items-center justify-between text-xs font-mono">
                  ...
                  <span className="text-foreground font-bold">{skillProficiency}%</span>
                </div>
                <input
                  type="range"
                  min="50"
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-xs font-mono">
                  ...
                  <span className="text-foreground font-bold">{experienceWeight}%</span>
                </div>
                <input
                  type="range"
                  min="50"
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-xs font-mono">
                  ...
                  <span className="text-foreground font-bold">{trustMultiplier}%</span>
                </div>
                <input
                  type="range"
                  min="50"
          ...
          <Card champagneBorder className="md:col-span-6 p-6 space-y-4">
            <CardHeader className="p-0 pb-2">
              <CardTitle className="text-base font-bold text-white flex items-center gap-2">
                <Cpu className="w-5 h-5 text-foreground" /> Deterministic Rule Checklist
              </CardTitle>
              <CardDescription className="text-xs">
