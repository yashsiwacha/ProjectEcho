      ...
      >
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <Button
            ...
            className="gap-2 font-bold shadow-lg shadow-sm text-xs"
          >
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <Card champagneBorder className="md:col-span-7 p-6 space-y-4">
            <CardHeader className="p-0 pb-2">
              <CardTitle className="text-base font-bold text-white flex items-center gap-2">
                <Zap className="w-4 h-4 text-foreground" /> Cryptographically Verified Skills
              </CardTitle>
          ...
          <Card champagneBorder className="md:col-span-5 p-6 space-y-4 flex flex-col justify-between">
            <div className="space-y-3">
              <CardHeader className="p-0 pb-2">
                <CardTitle className="text-base font-bold text-white flex items-center gap-2">
                  <ShieldCheck className="w-4 h-4 text-foreground" /> Shareable Provenance Link
                </CardTitle>
                <CardDescription className="text-xs">
            ...
            <Button
              ...
              size="sm"
              onClick={handleCopyShareLink}
              className="w-full gap-2 text-xs border-border text-foreground hover:bg-muted"
            >
