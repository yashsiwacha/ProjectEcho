...
The repository cannot proceed to the EAD, EDF or PRD layers. Four blockers are structural rather than incidental: the product is undefined, the governance model that both Frozen ADRs depend on does not exist, the domain framework that owns all business terminology does not exist, and the EAF cannot be ratified while its conflicts with a Frozen ADR are open.
...
|---|---|---|
| [ADR-001](docs/adr/ADR-001-career-intelligence-framework-foundations.md) | Approved — Frozen | 19 decisions. Bounds a CIF that does not exist ([CR-003](docs/reports/engineering/CONFLICT_REGISTER.md#cr-003)). |
| [ADR-0002](docs/adr/ADR-0002-modular-monolith-foundational-architecture.md) | Approved — Frozen | Governed by an FGM that does not exist ([CR-002](docs/reports/engineering/CONFLICT_REGISTER.md#cr-002)). Declares it supersedes itself ([CR-004](docs/reports/engineering/CONFLICT_REGISTER.md#cr-004)). |
...
| [Conflict Register](docs/reports/engineering/CONFLICT_REGISTER.md) | Active | 14 open, 0 resolved. |
| FGM | **Not yet available** | Blocking. |
| CIF | **Not yet available** | Blocking. |
| EAD, EDF, PRD, RAR, GAR | **Not yet available** | Blocked downstream. |
...
|---|---|---|---|
| 1 | **Which product is ProjectEcho?** | PRD, EAD, EDF, all implementation | [CR-001](docs/reports/engineering/CONFLICT_REGISTER.md#cr-001) |
| 2 | **Commission the FGM.** | Every future ADR, EAF ratification, freeze semantics | [CR-002](docs/reports/engineering/CONFLICT_REGISTER.md#cr-002) |
| 3 | **Commission the CIF.** | EAF ratification, all business terminology | [CR-003](docs/reports/engineering/CONFLICT_REGISTER.md#cr-003) |
| 4 | **Record the ARBR-0001 outcome**, incl. FD-001..FD-004. | Module governance rules | [CR-008](docs/reports/engineering/CONFLICT_REGISTER.md#cr-008) |
| 5 | **Name owner + date** for the ADR-0002 migration assessment. | Backend direction | [CR-005](docs/reports/engineering/CONFLICT_REGISTER.md#cr-005) |
| 6 | **Is Kafka in the frozen stack?** | Infrastructure, event design | [CR-006](docs/reports/engineering/CONFLICT_REGISTER.md#cr-006) |
| 7 | **Resolve the five EAF questions.** | EAF ratification | [CR-009](docs/reports/engineering/CONFLICT_REGISTER.md#cr-009) |
| 8 | **Locate or re-issue Product Impact Report 001.** | ADR-0002 traceability, tenancy | [CR-011](docs/reports/engineering/CONFLICT_REGISTER.md#cr-011) |
| 9 | **Document precedence:** manifest vs Documentation Standard. | Which document wins any dispute | [CR-014](docs/reports/engineering/CONFLICT_REGISTER.md#cr-014) |
| 10 | **Choose a licence.** | Public release | [CR-013](docs/reports/engineering/CONFLICT_REGISTER.md#cr-013) |

New ADRs proposed by DAR-0001: product definition of record; identifier correction for the superseded microservice ADR; disposition of the backend scaffold; event transport. Identifiers are **not** assigned — issuing one is a governance act under the FGM, which does not exist.
